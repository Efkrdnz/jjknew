...
public class JjkStrongestModVariables {
	...
	public static class EventBusVariableHandlers {
		...
		public static void clonePlayer(PlayerEvent.Clone event) {
			...
			if (!event.isWasDeath()) {
				...
				clone.CE_FLOW = original.CE_FLOW;
	...
	public static class PlayerVariables {
		...
		public Tag writeNBT() {
			...
			nbt.putBoolean("CE_FLOW", CE_FLOW);
			nbt.putBoolean("fullbright", fullbright);
			nbt.putBoolean("precision", precision);
			return nbt;
		}
		...
		public void readNBT(Tag tag) {
			...
			CE_FLOW = nbt.getBoolean("CE_FLOW");
			fullbright = nbt.getBoolean("fullbright");
			precision = nbt.getBoolean("precision");
		}
	}
