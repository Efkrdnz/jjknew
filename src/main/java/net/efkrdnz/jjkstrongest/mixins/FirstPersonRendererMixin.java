...
import net.efkrdnz.jjkstrongest.procedures.GetCurrentArmPoseProcedure;
import net.efkrdnz.jjkstrongest.procedures.ArmAnimationRegistryProcedure;
import net.efkrdnz.jjkstrongest.procedures.ArmAnimationDataProcedure;
