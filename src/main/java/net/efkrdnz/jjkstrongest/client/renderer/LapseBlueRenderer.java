...
import net.efkrdnz.jjkstrongest.entity.model.LapseBlueModel;
import net.efkrdnz.jjkstrongest.entity.layer.LapseBlueLayer;
...
public class LapseBlueRenderer extends GeoEntityRenderer<LapseBlueEntity> {
	...
	@Override
	public void preRender(PoseStack poseStack, LapseBlueEntity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, int colour) {
		float scale = 0.1f;
