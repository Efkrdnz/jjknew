...
public class Modelfire_arrow_Converted_Converted<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("jjk_strongest", "modelfire_arrow_converted_converted"), "main");
