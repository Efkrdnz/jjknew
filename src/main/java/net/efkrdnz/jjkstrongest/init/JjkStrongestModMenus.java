...
public class JjkStrongestModMenus {
	...
	public static final RegistryObject<MenuType<ArmAnimationEditorMenu>> ARM_ANIMATION_EDITOR = REGISTRY.register("arm_animation_editor", () -> IMenuTypeExtension.create(ArmAnimationEditorMenu::new));
}
