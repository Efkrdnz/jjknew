...
public class BlueVortexProcedure {
	...
	public static void onPlayerTick(PlayerTickEvent.Post event) {
		tickPlayer(event.getEntity().level(), event.getEntity());
	}
	...
	private static void playSound(Level world, BlockPos pos, String sound, float volume, float pitch) {
		world.playSound(null, pos, net.minecraft.core.registries.BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse(sound)), SoundSource.PLAYERS, volume, pitch);
	}
}
