...
public class ArmAnimationRegistryProcedure {
    ...
    static {
    	...
    	//sukuna domain pose
    	ANIMATIONS.put("gojo_tp", new ArmAnimationDataProcedure("gojo_tp")
    		.setArms(true, true)
    		.setForceVisible(true)
    		// right arm
    		.setRightStartPose(1.00f, 0.1f, -0.51f, 0f, 76.25f, 0f)
    		.setRightEndPose(1.00f, 0.1f, -0.51f, 0f, 76.25f, 0f)
    		// left arm
    		.setLeftStartPose(-1.00f, 0.1f, -0.51f, 0f, -76.25f, 0f)
    		.setLeftEndPose(-1.00f, 0.1f, -0.51f, 0f, -76.25f, 0f)
    		.setDuration(2f)
    		.setEasing("ease_in_out"));
    	...
    	//gojo blue vortex pose - right palm forward, left arm bracing
    	ANIMATIONS.put("blue_vortex", new ArmAnimationDataProcedure("blue_vortex")
    		.setArms(true, true)
    		.setForceVisible(true)
    		// right arm
    		.setRightStartPose(0.72f, 0.18f, -0.74f, -18.00f, 34.00f, 4.00f)
    		.setRightEndPose(0.72f, 0.18f, -0.74f, -18.00f, 34.00f, 4.00f)
    		// left arm
    		.setLeftStartPose(-0.54f, 0.31f, -0.42f, -18.00f, -38.00f, 0f)
    		.setLeftEndPose(-0.54f, 0.31f, -0.42f, -18.00f, -38.00f, 0f)
    		.setDuration(6f)
    		.setEasing("ease_out"));
