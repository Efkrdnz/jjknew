	...
	public static void execute(LevelAccessor world, Entity entity, LivingEntity target) {
		...
		if (t == 1) {
			...
			if (world instanceof ServerLevel level) {
				level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()),
					BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("minecraft:entity.iron_golem.attack")),
		...
		if (wcPhase == 1) {
			...
			if (apexElapsed >= 7) {
				...
				if (world instanceof ServerLevel level) {
					level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()),
						BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("minecraft:entity.wither.shoot")),
		...
		if (wcPhase == 2) {
			...
			if (entity.onGround()) {
				...
				if (world instanceof ServerLevel level) {
					...
					level.playSound(null, BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()),
						BuiltInRegistries.SOUND_EVENT.get(ResourceLocation.parse("minecraft:entity.generic.explode")),
