...
public class RenderMarkedEntitiesProcedure {
	// textures for marks
	private static final ResourceLocation SUKUNA_MARK = ResourceLocation.fromNamespaceAndPath("jjk_strongest", "textures/mark_sukuna.png");
	private static final ResourceLocation GOJO_MARK = ResourceLocation.fromNamespaceAndPath("jjk_strongest", "textures/mark_gojo.png");
	private static final ResourceLocation SUKUNA_MARK_TARGETED = ResourceLocation.fromNamespaceAndPath("jjk_strongest", "textures/mark_sukuna_targeted.png");
	private static final ResourceLocation GOJO_MARK_TARGETED = ResourceLocation.fromNamespaceAndPath("jjk_strongest", "textures/mark_gojo_targeted.png");
