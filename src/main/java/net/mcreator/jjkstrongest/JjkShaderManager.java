...
public class JjkShaderManager {
	...
	public static void registerShaders(net.minecraftforge.client.event.RegisterShadersEvent event) {
		...
		try {
			...
			event.registerShader(new ShaderInstance(event.getResourceProvider(), new ResourceLocation("jjk_strongest", "blue_vortex"), DefaultVertexFormat.POSITION_TEX), shader -> {
		...
		try {
			event.registerShader(new ShaderInstance(event.getResourceProvider(), new ResourceLocation("jjk_strongest", "fuga_domain_explosion"), DefaultVertexFormat.POSITION_TEX), shader -> {
		...
		try {
			event.registerShader(new ShaderInstance(event.getResourceProvider(), new ResourceLocation("jjk_strongest", "hollow_nuke"), DefaultVertexFormat.POSITION_TEX), shader -> {
		...
		try {
			...
			event.registerShader(new ShaderInstance(event.getResourceProvider(), new ResourceLocation("jjk_strongest", "lapse_blue_liquid"), DefaultVertexFormat.POSITION_TEX), shader -> {
