...
import net.mcreator.jjkstrongest.procedures.ReturnBookSukunaProcedure;
...
public class DomainCastOverlaySukunaOverlay {
	...
	public static void eventHandler(RenderGuiEvent.Pre event) {
		...
		if (ReturnBookSukunaProcedure.execute(entity)) {
			event.getGuiGraphics().blit(new ResourceLocation("jjk_strongest:textures/screens/benevolant_sanctuary.png"), w / 2 + -42, h / 2 + -92, 0, 0, 84, 84, 84, 84);
		}
