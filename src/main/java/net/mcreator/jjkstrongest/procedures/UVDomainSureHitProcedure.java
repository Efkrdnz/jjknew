	...
	public static void execute(LevelAccessor world, Entity entity) {
			...
			return;
		{
			...
			for (Entity entityiterator : _entfound) {
				if (!(entityiterator.getStringUUID()).equals(entity.getPersistentData().getString("ownerUUID")) && !entityiterator.getType().is(TagKey.create(Registries.ENTITY_TYPE, new ResourceLocation("technique")))) {
