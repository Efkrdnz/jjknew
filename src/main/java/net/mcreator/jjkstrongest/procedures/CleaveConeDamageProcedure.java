...
public class CleaveConeDamageProcedure {
	public static void execute(LevelAccessor world, Entity entity, double range, float coneDegrees, float damage) {
		...
		DamageSource ds = new DamageSource(lvl.registryAccess().registryOrThrow(Registries.DAMAGE_TYPE).getHolderOrThrow(ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation("jjk_strongest:technique_cleave"))), entity);
