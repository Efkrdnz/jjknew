...
public class BlueParticleExecuteProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		for (int index1 = 0; index1 < 5; index1++) {
			...
			Yc = entity.getY() + 0.1;
			Zc = entity.getZ();
			X0 = entity.getX() + Mth.nextDouble(RandomSource.create(), -1, 1);
			Y0 = entity.getY() + Mth.nextDouble(RandomSource.create(), -1, 1);
			Z0 = entity.getZ() + Mth.nextDouble(RandomSource.create(), -1, 1);
			Xd = (Xc - X0) * 0.1;
			Yd = (Yc - Y0) * 0.1;
			Zd = (Zc - Z0) * 0.1;
