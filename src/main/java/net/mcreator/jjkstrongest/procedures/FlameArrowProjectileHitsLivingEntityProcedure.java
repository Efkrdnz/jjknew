...
public class FlameArrowProjectileHitsLivingEntityProcedure {
		...
		if (world instanceof ServerLevel _serverLevel) {
			...
			if (entityinstance != null) {
				...
				if (immediatesourceentity instanceof Projectile) {
					shooter = ((Projectile) immediatesourceentity).getOwner();
				}
				if (entityinstance instanceof TamableAnimal _toTame && shooter instanceof Player _owner) {
					_toTame.tame(_owner);
				}
