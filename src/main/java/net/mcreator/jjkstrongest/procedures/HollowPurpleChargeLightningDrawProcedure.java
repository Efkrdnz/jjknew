...
public class HollowPurpleChargeLightningDrawProcedure {
	public static void execute(LevelAccessor world, double end_x, double end_y, double end_z, double start_x, double start_y, double start_z) {
		...
		for (int index1 = 0; index1 < (int) (steps + 1); index1++) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles((SimpleParticleType) (JjkStrongestModParticleTypes.PARTICLE_HP_CHARGE_2.get()), x, y, z, 1, 0, 0, 0, 0);
		...
		if (hasBranched) {
			...
			if (branchSteps > 0) {
				...
				for (int index1 = 0; index1 < (int) (branchSteps + 1); index1++) {
					...
					if (world instanceof ServerLevel _level)
						_level.sendParticles((SimpleParticleType) (JjkStrongestModParticleTypes.PARTICLE_HP_CHARGE.get()), x, y, z, 1, 0, 0, 0, 0);
				}
			}
		}
	}
