...
import net.mcreator.jjkstrongest.init.JjkStrongestModTabs;
import net.mcreator.jjkstrongest.init.JjkStrongestModSounds;
...
import net.mcreator.jjkstrongest.init.JjkStrongestModMenus;
...
import net.mcreator.jjkstrongest.init.JjkStrongestModBlockEntities;
...
public class JjkStrongestMod {
	...
	public static class initer {
		...
		public static void init(FMLCommonSetupEvent event) {
			JjkStrongestMod.addNetworkMessage(TextboxSetMessage.class, TextboxSetMessage::buffer, TextboxSetMessage::new, TextboxSetMessage::handler);
		}
	}
