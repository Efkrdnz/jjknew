...
import net.mcreator.jjkstrongest.block.entity.CustomPortalBlockEntity;
import net.mcreator.jjkstrongest.JjkStrongestMod;

public class JjkStrongestModBlockEntities {
	public static final DeferredRegister<BlockEntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, JjkStrongestMod.MODID);
