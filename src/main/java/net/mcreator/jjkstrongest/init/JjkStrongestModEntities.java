...
import net.mcreator.jjkstrongest.entity.SukunaEntity;
...
import net.mcreator.jjkstrongest.entity.HollowNukeEntity;
import net.mcreator.jjkstrongest.entity.FugaDomainExplosionEntity;
