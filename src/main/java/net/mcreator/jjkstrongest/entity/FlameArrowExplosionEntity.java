...
import net.mcreator.jjkstrongest.procedures.FlameArrowExplosionOnEntityTickUpdateProcedure;
...
public class FlameArrowExplosionEntity extends TamableAnimal {
	...
	public void baseTick() {
		super.baseTick();
		FlameArrowExplosionOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
