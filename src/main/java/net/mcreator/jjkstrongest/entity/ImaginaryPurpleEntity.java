...
import net.mcreator.jjkstrongest.procedures.ImaginaryPurpleOnEntityTickUpdateProcedure;
...
public class ImaginaryPurpleEntity extends TamableAnimal {
	...
	public void baseTick() {
		super.baseTick();
		ImaginaryPurpleOnEntityTickUpdateProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), this);
	}
