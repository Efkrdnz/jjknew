...
import net.mcreator.jjkstrongest.procedures.DomainUVEntityTickProcedure;
import net.mcreator.jjkstrongest.init.JjkStrongestModEntities;

public class DomainUVEntity extends PathfinderMob {
	public DomainUVEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(JjkStrongestModEntities.DOMAIN_UV.get(), world);
	}
